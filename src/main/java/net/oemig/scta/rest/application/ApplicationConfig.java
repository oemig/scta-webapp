package net.oemig.scta.rest.application;
...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        resources.add(net.oemig.scta.rest.provider.JsonMoxyConfigurationContextResolver.class);
        resources.add(net.oemig.scta.rest.resource.AdministrationResource.class);
